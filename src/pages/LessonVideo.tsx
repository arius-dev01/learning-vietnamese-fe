...
export default function LessonVideo() {
  ...
  const youtubeUrl =
    ...
    `https://www.youtube.com/embed/y5Gk0MHMp0I?autoplay=0&controls=1&modestbranding=1&rel=0&showinfo=0&disablekb=1&fs=0&origin=${window.location.origin}`;
  return (
    <>
      <Header />
              ...
              <div className="mt-6 bg-[#1b262c] p-6 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="text-white ml-2">
                      {lessonDetails?.vocabularies.length} phrases
                    </span>
                  </div>
                  <div>
