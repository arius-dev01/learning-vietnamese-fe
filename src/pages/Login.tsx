    ...
    <div className="bg-[#141f25] min-h-screen">
      ...
      <div className=" flex items-center justify-center">
        <div className=" max-w-[400px] w-full p-4 rounded-md">
          <h2 className="text-center text-white text-[25px] font-bold mb-4">
            {t("Log in")}
          </h2>{" "}
          {/* ✅ Translation */}
          <form
          ...
          >
            <div className="relative">
              ...
              {value && (
                <button
                  onClick={() => setValue("")}
                  className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full w-4 h-4  bg-gray-600 flex items-center justify-center font-semibold"
                >
            ...
            <div className="flex justify-end">
              <button
                ...
                className="text-cyan-500 cursor-pointer hover:underline  text-sm"
              >
            ...
            <button
              type="submit"
              className="bg-[#49C0F8] cursor-pointer hover:bg-white hover:text-[#49C0F8] font-semibold py-4 rounded-xl"
            >
