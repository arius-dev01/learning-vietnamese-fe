        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2.5 border border-gray-200 rounded-lg  focus:ring-[#007AFF]  text-sm font-medium tracking-tight"
            />
            {searchTerm && (
              <button
                onClick={() => {
          ...
          <select
            ...
            className="px-4 cursor-pointer py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-0 focus:ring-[#007AFF] text-sm font-medium tracking-tight min-w-[140px]"
          >
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-left py-4 px-8 font-semibold text-gray-900 text-sm tracking-tight">
                  Actions
                </th>
              </tr>
            </thead>
                ...
                >
                  <td className="py-4 px-6">
                    <div>
                      ...
                      <p className="text-gray-500 line-clamp-2 text-xs mt-1 leading-relaxed">
                        {lesson.describe}
                      </p>
                    </div>
                  </td>
                  ...
                  <td className="py-4 px-6">
                    <span className="text-gray-500 text-sm">
                      {new Date(lesson.updated).toLocaleDateString()}
                    </span>
                  </td>
                  <td className="py-4 px-6">
                    <span className="text-gray-500 text-sm">
        ...
        {lessons.length === 0 && (
          <div className="text-center py-12">
            ...
            <button
              ...
              className="mt-4 text-[#007AFF] cursor-pointer hover:text-[#0056CC] text-sm font-medium"
            >
              Clear filters
            </button>
          </div>
        ...
        <div className="flex items-center justify-between bg-white px-6 py-4 rounded-xl">
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-2 text-sm cursor-pointer font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Previous
            </button>
            {data?.totalPage &&
